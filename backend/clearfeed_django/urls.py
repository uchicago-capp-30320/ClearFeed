"""
URL configuration for clearfeed_django project.
...
urlpatterns = [
    ...
    path("home/", views.api_home_summary, name="home_summary_api"),
    # auth-specific routing
    path("feed-summary/", views.api_feed_summary, name="feed_summary"),
